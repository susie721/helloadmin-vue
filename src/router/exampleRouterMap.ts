...
export const example: Router = {
    ...
    children: [
        // dashboard
        {
            ...
            children: [
                ...
                // },
                {
                    path: 'workplace',
                    name: 'Workplace',
                    component: constantRouterComponents['Home'],
                    meta: { title: 'menu.dashboard.title', keepAlive: true, permission: ['admin'] }
                }
            ]
        },
        // {
        ...
        // },
        {
            path: '/departmentUser',
            name: 'DepartmentUser',
            component: () => import('@/views/departmentUser/index.vue'),
            meta: { title: 'menu.department.title', icon: 'user', keepAlive: false, permission: ['admin'], hidden: false },
            // children: [
            //     {
            //         path: '/departmentUser-list',
            //         name: 'DepartmentUserList',
            //         component: () => import('@/views/departmentUser/index.vue'),
            //         meta: { title: 'menu.departmentUser.list-title', icon: 'set', keepAlive: false, permission: ['admin'], hidden: false },
            //     }
            // ]
        },
        {
        ...
        },
        {
            ...
            name: 'Log',
            component: RouteView,
            meta: { title: 'menu.log.title', icon: 'log1', keepAlive: false, permission: ['admin'], hidden: false },
            children: [
                {
                    path: 'login-log',
                    name: 'LoginLog',
                    component: () => import('@/views/log/login/index.vue'),
                    meta: { title: 'menu.log.login', icon: 'log', keepAlive: false, permission: ['admin'], hidden: false },
                }
            ]
        }
        // // forms
