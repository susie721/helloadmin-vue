...
export const PERMISSION_ROUTES = 'PERMISSION_ROUTES'
export const SET_LOCK_SCREEN = 'SET_LOCK_SCREEN'
export const SITE_PERMISSION = 'SITE_PERMISSION'
export const PERMISSION_ROLE = 'PERMISSION_ROLE'
export const PERMISSION_MENU = 'PERMISSION_MENU'
export const PERMISSION_ABILITY = 'PERMISSION_ABILITY'
export const PERMISSION_USERINFO = 'PERMISSION_USERINFO'
