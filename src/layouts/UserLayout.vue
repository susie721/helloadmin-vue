<template>
  <div id="userLayout" :class="['user-layout-wrapper', isMobile && 'mobile']">
    <a-row :wrap="true" class="login">
      <a-col :lg="14" :xl="16">
        <a-flex class="left" justify="center">
          <img src="~@/assets/bg_login.png" alt="login-bg" />
        </a-flex>
      </a-col>
      <a-col :lg="10" :xl="8" class="right">
        <router-view />
      </a-col>
    </a-row>
    <!-- <div class="container">
...
#userLayout.user-layout-wrapper {
  ...
  .container {
    width: 100%;
    min-height: 100%;
    background: #f0f2f5 url(../assets/right_background.png) no-repeat 50%;
    background-size: 100%;
    //padding: 50px 0 84px;
    position: relative;
